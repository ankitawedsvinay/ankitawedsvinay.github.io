    ...
    <div className="invitation-card">
      <div className="screen">
        ...
        <div className="content">
          <div className="title">
            <p>
              Cordially Invite your esteemed presence with family on the
          ...
          <div className="side">
            <div className="bridegroom">
              ...
              <p>
                {heroine.paternalGrandParents[0]} &{" "}
                {heroine.paternalGrandParents[1]}
              </p>
              <p>
                {heroine.maternalGrandParents[0]} &{" "}
                {heroine.maternalGrandParents[1]}
              </p>
            </div>
            <div>
              <p>with</p>
            ...
            <div className="bridegroom">
              ...
              <p>
                {hero.maternalGrandParents[0]} & {hero.maternalGrandParents[1]}
              </p>
            </div>
          </div>
        </div>
